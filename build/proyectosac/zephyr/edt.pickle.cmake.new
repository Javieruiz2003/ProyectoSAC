...
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODELABEL|spi2_default" "/pin-controller/spi4_default")
...
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODELABEL|spi2_sleep" "/pin-controller/spi4_sleep")
